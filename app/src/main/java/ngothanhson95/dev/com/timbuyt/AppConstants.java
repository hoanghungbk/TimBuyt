...
public final class AppConstants {
    ...
    public static final int FAILTURE_RESULT =1;
    public static final String PACKAGE_NAME = "ngothanhson95.dev.com.timbuyt";
    ...
    public static final int PLACE_PICKER_CODE = 11;
